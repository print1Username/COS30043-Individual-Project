...
async function loadProducts() {
  ...
  try {
    ...
    console.error('[products:my]', error)
  ...
  <div class="my-products-view">
    <header class="my-products-header">
      <div class="my-products-heading">
        ...
        <h2 class="text-h4 font-weight-bold mb-2">My Products</h2>
        <p class="text-body-2 my-products-description">Manage your product catalogue.</p>
      </div>
    ...
    <div class="my-products-summary">
      <span>{{ resultSummary }}</span>
      <span>{{ viewMode === 'grid' ? '16 per page' : '10 per page' }}</span>
    </div>

    <ProductsTable :products="products" :mode="viewMode" :loading="loading" :show-creator="false" />
